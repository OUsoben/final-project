  ...
  return (
    <div className="bg-light">
      ...
      <section className="p-5 d-flex ">
        ...
        <p>Explore our wide range of products, including athletic apparel, footwear, accessories, and more. Our knowledgeable staff is here to help you find the perfect gear to elevate your game.</p>
        </div>
        <img className="img-fluid col-lg-5 rounded me-5 col-md-3" src="https://chchurches.org/wp-content/uploads/2017/10/Fotolia_119039468_Subscription_Monthly_M.jpg" alt="" />
      </section>
      <section className="p-5 d-flex container ">
           <img className="  img-fluid col-lg-3  rounded" src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/34/Elon_Musk_Royal_Society_%28crop2%29.jpg/773px-Elon_Musk_Royal_Society_%28crop2%29.jpg" alt="" />
          <div className="p-5">
          <h2 className="fw-bold ">Mr.Elon Musk</h2>
           <p className="fs-5">CEO, Founder</p>
           <hr />
           <p>Hello, The sport Store community! This is Elon Musk , and I am incredibly excited to connect with you today as the CEO of our beloved sports store. At the Sport store, our mission goes beyond simply providing sports gear — we are dedicated to empowering each of you on your unique journey to a healthier, more active lifestyle.As we look ahead, our focus remains on innovation, customer satisfaction, and community engagement. I can't wait to share more details with you soon.</p>
          </div>
        </section>
        <section className="p-5 d-flex  col-lg-10 ms-5">
           ...
           <hr />
           <p>Hello, everyone! I'm Ben, and I'm thrilled to connect with you today as a developer. Whether you're a fellow coder, a client, or just someone interested in the tech world, I'm excited to share a bit about what I do and the passion that drives me.</p>
           </div>
           <img className="  img-fluid col-lg-3  rounded" src="https://images.pexels.com/photos/220453/pexels-photo-220453.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" alt="" />
        </section>
